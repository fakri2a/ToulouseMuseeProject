	...
	<body>
		...
		<div id="show-musee" class="content scaffold-show" role="main">
			...
			<ol class="property-list musee">
				...
				<li class="fieldcontain">
					<span id="accessMetro-label" class="property-label"><g:message code="musee.accessMetro.label" default="Access Metro" /></span>

						<span class="property-value" aria-labelledby="accessMetro-label"><g:fieldValue bean="${museeInstance}" field="accessMetro"/></span>
				...
				<li class="fieldcontain">
					<span id="accessBus-label" class="property-label"><g:message code="musee.accessBus.label" default="Access Bus" /></span>

						<span class="property-value" aria-labelledby="accessBus-label"><g:fieldValue bean="${museeInstance}" field="accessBus"/></span>
				...
				<li class="fieldcontain">
					<span id="demandeVisiteMusees-label" class="property-label"><g:message code="musee.demandeVisiteMusees.label" default="Demande Visite Musees" /></span>

						<g:each in="${museeInstance.demandeVisiteMusees}" var="d">
						<span class="property-value" aria-labelledby="demandeVisiteMusees-label"><g:link controller="demandeVisiteMusee" action="show" id="${d.id}">${d?.encodeAsHTML()}</g:link></span>
						</g:each>
